...
#'
#' Or use the function: system.file("extdata", "oildata.csv", package = "olr", mustWork = TRUE)
#'
...
#' expvarnames <- c('SP500', 'RigCount', 'API', 'Field_Production', 'RefinerNetInput', 'OperableCapacity', 'Imports', 'StocksExcludingSPR')
...
olr <- function(datasetname, resvarname, expvarnames, adjr2 = TRUE){
  ...
  if (adjr2 == "TRUE" || adjr2 == "True" || adjr2 == "true" || adjr2 == TRUE || adjr2 == True || adjr2 == true || adjr2 == T){
  ...
  } else if (adjr2 == "FALSE" || adjr2 == "False" || adjr2 == "false" || adjr2 == FALSE || adjr2 == False || adjr2 == false || adjr2 == F) {
